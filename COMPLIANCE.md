...
> [!NOTE]
> **⚠️ Partial Support**: OpenJPH focuses on HTJ2K performance rather than full legacy Part 1 features (e.g. ROI, complex layering).
...
- **Quality Layers**: Multiple quality layer decoding not yet optimized.
- **ROI Coding**: Region of Interest is not implemented.
- **ICC Profiles**: Color profile embedding in JP2 boxes not yet supported.
