...
fn test_htj2k_encoder_openhtj2k_decoder() {
    ...
    // Save encoded stream
    fs::write("tests/fixtures/out/test_our_htj2k.jhc", &output).expect("Failed to write encoded file");
    ...
    let decode_output = Command::new(dec_bin)
        .args(&["-i", "tests/fixtures/out/test_our_htj2k.jhc", "-o", "test_our_htj2k.pgm"])
        .output()
