...
fn test_htj2k_minimal_2x2_black() {
    ...
    save_pgm("tests/fixtures/out/test_2x2_black.pgm", &pixels, width, height).unwrap();
    
    let output = Command::new("./open_htj2k_enc.exe")
        .args(&["-i", "tests/fixtures/out/test_2x2_black.pgm", "-o", "tests/fixtures/out/test_2x2_black.j2c", "Creversible=yes"])
        .env("HTJ2K_DEBUG", "1")
        .output()
    ...
    println!("Encoded file size: {} bytes", fs::metadata("tests/fixtures/out/test_2x2_black.j2c").unwrap().len());
...
fn test_htj2k_minimal_2x2_white() {
    ...
    save_pgm("tests/fixtures/out/test_2x2_white.pgm", &pixels, width, height).unwrap();
    
    let output = Command::new("./open_htj2k_enc.exe")
        .args(&["-i", "tests/fixtures/out/test_2x2_white.pgm", "-o", "tests/fixtures/out/test_2x2_white.j2c", "Creversible=yes"])
        .env("HTJ2K_DEBUG", "1")
        .output()
        .expect("Failed to run encoder");
...
fn test_htj2k_minimal_2x2_checker() {
    ...
    save_pgm("tests/fixtures/out/test_2x2_checker.pgm", &pixels, width, height).unwrap();
    
    let output = Command::new("./open_htj2k_enc.exe")
        .args(&["-i", "tests/fixtures/out/test_2x2_checker.pgm", "-o", "tests/fixtures/out/test_2x2_checker.j2c", "Creversible=yes"])
        .env("HTJ2K_DEBUG", "1")
        .output()
        .expect("Failed to run encoder");
...
fn test_htj2k_minimal_4x4_gradient() {
    ...
    save_pgm("tests/fixtures/out/test_4x4_grad.pgm", &pixels, width, height).unwrap();
    
    let output = Command::new("./open_htj2k_enc.exe")
        .args(&["-i", "tests/fixtures/out/test_4x4_grad.pgm", "-o", "tests/fixtures/out/test_4x4_grad.j2c", "Creversible=yes", "Clevels=0"])
        .env("HTJ2K_DEBUG", "1")
        .output()
        .expect("Failed to run encoder");
...
fn test_our_htj2k_encoder_with_openhtj2k_decoder() {
    ...
    let decode_output = Command::new("./open_htj2k_dec.exe")
        .args(&["-i", "tests/fixtures/out/test_our_htj2k.j2c", "-o", "tests/fixtures/out/test_our_htj2k_decoded.pgm"])
        .output()
